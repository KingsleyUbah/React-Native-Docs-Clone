...
import styles from '../../components/callout.module.css'
...
<Callout content={"While we do our best to assume no prior knowledge of React, Android, or iOS development, these are valuable topics of study for the aspiring React Native developer. Where sensible, we have linked to resources and articles that go more in depth."}/>
...
<Callout content={"Optionally, if you want to setup a local development environment, you can follow our guide to setting up your environment on your local machine and paste the code examples into your App.js file there. (If you are a web developer, you may already have a local environment set up for mobile browser testing!)"}/>
...
<Tabs items={['Functional Component', 'Class Component']}>
  <Tab>
    ```js
    import React from 'react';
    import {Text, View} from 'react-native';
...
<Tabs items={['Android', 'iOS', 'Web']}>
  <Tab>
    <Callout content={"Android developers may be familiar with this concept."}/>
  </Tab>
  <Tab>
    <Callout content={"iOS developers may be familiar with this concept."}/>
  </Tab>
  <Tab>
    <Callout content={"Web developers may be familiar with this concept."}/>
  </Tab>
</Tabs>
